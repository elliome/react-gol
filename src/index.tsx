            ...
            if (lastFrameTime < Date.now() - config.minFrameTime) {
                ...
                for (let x = 0; x < grid.length; x++) {
                    ...
                    for (let y = 0; y < grid[x].length; y++) {
                        ...
                        const neighbours = top + topLeft + topRight + bot + botLeft + botRight + left + right;
                ...
                for (let x = 0; x < grid.length; x++) {
                    for (let y = 0; y < grid[x].length; y++) {
                        if (grid[x][y]) {
                            context.fillRect(x * config.cellSize, y * config.cellSize, config.cellSize, config.cellSize)
                        }
                    }
                }
